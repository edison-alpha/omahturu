...
type MapProps = {
  children?: ReactNode;
  /** Custom map style. Defaults to CARTO light style. */
...
const Map = forwardRef<MapRef, MapProps>(function Map(
  ...
  const mapStyle = useMemo(() => style ?? defaultStyles.light, [style]);
  ...
  return (
    <MapContext.Provider value={contextValue}>
      <div ref={containerRef} className="relative w-full h-full" style={{ minHeight: '100%', height: '100%' }}>
